                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="student_id" class="form-control form-control-alternative" value="<?php echo $row['student_id']; ?>" placeholder="ตัวอย่าง : 3404501678219" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control form-control-alternative" name="student_prefix">
                                                    <option value="นาย" <?php if($row['student_prefix']=="นาย"){ echo "selected"; }?>>นาย</option>
                                                    <option value="นาง" <?php if($row['student_prefix']=="นาง"){ echo "selected"; }?>>นาง</option>
                                                    <option value="นางสาว" <?php if($row['student_prefix']=="นางสาว"){ echo "selected"; }?>>นางสาว</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="student_fname" class="form-control form-control-alternative" placeholder="ตัวอย่าง : ประกาษิศ" value="<?php echo $row['student_fname']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-last-name">นามสกุล</label>
                                                <input type="text" name="student_lname" class="form-control form-control-alternative" value="<?php echo $row['student_lname']; ?>" placeholder="ตัวอย่าง : นิติโรชภานิชย์" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="student_tel" class="form-control form-control-alternative" value="<?php echo $row['student_tel']; ?>" placeholder="ตัวอย่าง : 0987654321" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-last-name">รหัสผ่าน</label>
                                                <input type="password" name="student_password" class="form-control form-control-alternative" value="<?php echo $row['password']; ?>" placeholder="ตัวอย่าง : 0987654321" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-primary" name="update" value="<?php echo $_SESSION['student'][0]; ?>">Save </button>
                                    </div>
                                </div>
                            </form>
                        </div>
